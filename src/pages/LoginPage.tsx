...
export default function LoginPage({ onLoginSuccess }: LoginPageProps) {
  ...
  const [password, setPassword] = useState(''); // Preparado para futuro
  ...
  const handleNuvemshopLogin = async () => {
    ...
    try {
        ...
        // 2. Redireciona o usuário para a Nuvemshop
        // Eles vão autorizar e a Nuvemshop vai devolver para /callback no backend
        // O backend vai redirecionar de volta para o Dashboard com o token na URL.
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <form onSubmit={handleManualLogin}>
            ...
            {/* Campo de Senha (Visualmente pronto, backend ainda aceita vazio por enquanto) */}
...
// --- ESTILOS CSS-IN-JS (Moderno e Escuro) ---
...
const nuvemshopButtonStyle: React.CSSProperties = {
    ...
    borderRadius: '8px',
    border: 'none',
    backgroundColor: '#0b57d0', // Azul Nuvemshop aproximado
    color: 'white',
    fontWeight: 'bold',
    fontSize: '15px',
    cursor: 'pointer',
